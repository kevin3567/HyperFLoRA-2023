...
def args_parser():
    ...
    parser.add_argument('--local_bs', type=int, default=10, help="local training batch size")
    ...
    parser.add_argument('--iid', action='store_true', help='whether i.i.d or not (must be true)')
    parser.add_argument('--val_split', type=float, default=0.1, help="proportion of train data used for validation")
    parser.add_argument('--users_split_ratio', type=float, default=0.8, help="proportion of participants vs bystander")
    ...
    parser.add_argument('--load_ckpt', type=str, default='', help='define pretrained federated model path, must '
                                                                  ...
                                                                  'run_*_sd*/ (prevents inconsistencies).')
    ...
    parser.add_argument('--do_debug', action="store_true", default=False, help='run in debug mode (more printouts)')
